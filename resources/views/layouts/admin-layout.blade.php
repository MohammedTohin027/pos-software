...
<head>
    ...
    {{-- sweet-alert --}}
    <script src="{{ asset('public/common/sweetalert/sweetalert.min.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('public/common/sweetalert/sweetalert.min.css') }}">
    {{-- date picker --}}
    <link rel="stylesheet" href="{{ asset('public/common/datepicker/daterangepicker.css') }}">
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script src="{{ asset('public/backend/dist/js/handlebars/handlebars.min.js') }}"></script>
    <!-- AdminLTE App -->
    ...
    {{-- handle bars --}}
    <script src="{{ asset('public/common/handlebar/handlebars-v4.0.12.js') }}"></script>
    {{-- date picker --}}
    <script src="{{ asset('public/common/datepicker/daterangepicker.js') }}"></script>
    <script src="{{ asset('public/common/datepicker/locales.min.js') }}"></script>
    {{-- delete Sweetallert --}}
    <script>
        $(function() {
